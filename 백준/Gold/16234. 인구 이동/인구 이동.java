...
public class Main {
	...
	public static void main(String[] args) throws Exception{
		// bfs
		// 사방에 인접한 칸 중 L<= <=R 조건을 만족하는 칸 queue에 넣기
		// queue에 들어간 나라 개수 & 인구 수 합 확인 필요
		// 
		// 모든 칸에서 시작하는 bfs 진행?
		
		// bfs 진행하면서 인구 분배를 동시에 진행.....할 수는 없다
		// 인구 분배 어떻게 ? 
		// 큐에 들어갔었던 노드를 모두 리스트에 넣고
		// while문이 끝나면 리스트에 있는 노드 인구수 분배?
		
		// bfs를 NxN 까지 모두 마치면 하루 끝
		// 
		// 인구이동이 끝나는 조건? 모든 인접한 칸의 차이가 L<= <=R 을 만족하지 않을때
		// flag 세워서 국경개방을 하는 경우가 한번이라도 있으면 true
		// 하루가 끝났는데 !flag 일때 인구이동 끝내기 
